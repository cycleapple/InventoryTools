...
public class InventoryScannerDebuggerPane : IDebugPane
{
    ...
    public void Draw()
    {
        ImGui.TextUnformatted(T("Inventories Seen via Network Traffic"));
        foreach (var inventory in _inventoryScanner.LoadedInventories)
        {
            ImGui.TextUnformatted(inventory.ToString());
        }

        ImGui.TextUnformatted(T("Retainer Inventories Seen via Network Traffic"));
        ...
        if (ImGui.TreeNode(T("Character Bags 1##characterBags1")))
        {
        ...
        if (ImGui.TreeNode(T("Character Bags 2##characterBags2")))
        {
        ...
        if (ImGui.TreeNode(T("Character Bags 3##characterBags3")))
        {
        ...
        if (ImGui.TreeNode(T("Character Bags 4##characterBags4")))
        {
        ...
        if (ImGui.TreeNode(T("Character Equipped##characterEquipped")))
        {
        ...
        if (ImGui.TreeNode(T("Character Crystals##characterCrystals")))
        {
        ...
        if (ImGui.TreeNode(T("Character Currency##characterCurrency")))
        {
        ...
        if (ImGui.TreeNode(T("Saddlebag Left##saddlebagLeft")))
        {
        ...
        if (ImGui.TreeNode(T("Saddlebag Right##saddlebagRight")))
        {
        ...
        if (ImGui.TreeNode(T("Premium Saddlebag Left##premiumSaddleBagLeft")))
        {
        ...
        if (ImGui.TreeNode(T("Premium Saddlebag Right##premiumSaddleBagRight")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Head##armouryHead")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - MainHand##armouryMainHand")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Body##armouryBody")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Hands##armouryHands")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Legs##armouryLegs")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Feet##armouryFeet")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Off Hand##armouryOffHand")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Ears##armouryEars")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Neck##armouryNeck")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Wrists##armouryWrists")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - Rings##armouryRings")))
        {
        ...
        if (ImGui.TreeNode(T("Armoury - SoulCrystals##armourySoulCrystals")))
        {
        ...
        if (ImGui.TreeNode(T("Free Company Chest 1##freeCompanyBags1")))
        {
        ...
        if (ImGui.TreeNode(T("Free Company Chest 2##freeCompanyBags2")))
        {
        ...
        if (ImGui.TreeNode(T("Free Company Chest 3##freeCompanyBags3")))
        {
        ...
        if (ImGui.TreeNode(T("Free Company Chest 4##freeCompanyBags4")))
        {
        ...
        if (ImGui.TreeNode(T("Free Company Chest 5##freeCompanyBags5")))
        {
        ...
        if (ImGui.TreeNode(T("Free Company Currency##freeCompanyCurrency")))
        {
        ...
        if (ImGui.TreeNode(T("Armoire##armoire")))
        {
        ...
        if (ImGui.TreeNode(T("Glamour Chest##glamourChest")))
        {
        ...
        if (ImGui.TreeNode(T("Retainer Bag 1##retainerBag1")))
        {
            foreach (var retainer in _inventoryScanner.RetainerBag1)
            {
                if (ImGui.TreeNode(T("Retainer Bag ") + retainer.Key + "##1" + retainer.Key))
                {
        ...
        if (ImGui.TreeNode(T("Retainer Bag 2##retainerBag2")))
        {
            foreach (var retainer in _inventoryScanner.RetainerBag2)
            {
                if (ImGui.TreeNode(T("Retainer Bag ") + retainer.Key + "##2" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Bag 3##retainerBag3")))
        {
            foreach (var retainer in _inventoryScanner.RetainerBag3)
            {
                if (ImGui.TreeNode(T("Retainer Bag ") + retainer.Key + "##3" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Bag 4##retainerBag4")))
        {
            foreach (var retainer in _inventoryScanner.RetainerBag4)
            {
                if (ImGui.TreeNode(T("Retainer Bag ") + retainer.Key + "##4" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Bag 5##retainerBag5")))
        {
            foreach (var retainer in _inventoryScanner.RetainerBag5)
            {
                if (ImGui.TreeNode(T("Retainer Bag ") + retainer.Key + "##5" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Equipped##retainerEquipped")))
        {
            foreach (var retainer in _inventoryScanner.RetainerEquipped)
            {
                if (ImGui.TreeNode(T("Retainer Equipped") + retainer.Key + "##equipped" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Market##retainerMarket")))
        {
            foreach (var retainer in _inventoryScanner.RetainerMarket)
            {
                if (ImGui.TreeNode(T("Retainer Market") + retainer.Key + "##market" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Market Prices##retainerMarketPrices")))
        {
        ...
        if (ImGui.TreeNode(T("Retainer Crystals##retainerCrystals")))
        {
            foreach (var retainer in _inventoryScanner.RetainerCrystals)
            {
                if (ImGui.TreeNode(T("Retainer Crystals") + retainer.Key + "##crystals" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Retainer Gil##retainerGil")))
        {
            foreach (var retainer in _inventoryScanner.RetainerGil)
            {
                if (ImGui.TreeNode(T("Retainer Gil") + retainer.Key + "##gil" + retainer.Key))
                {
                    for (int i = 0; i < retainer.Value.Length; i++)
                    {
                        var item = retainer.Value[i];
        ...
        if (ImGui.TreeNode(T("Gearsets##gearsets")))
        {
        ...
        if (ImGui.TreeNode(T("Housing Inventories")))
        {
